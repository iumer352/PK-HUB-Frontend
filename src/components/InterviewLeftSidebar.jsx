    ...
    const fetchFeedback = async () => {
      if (selectedApplicant && selectedApplicant.interviews) {
          ...
          try {
            ...
            if (interview.stages[0].stage_id === 1) {
              const response = await axios.get(
                `https://kabi.pk.go1.kworld.kpmg.com/api/interview/stages/${interview.stages[0].stage_id}/applicant/${selectedApplicant.id}/hr-result`
              );
              if (isMounted) {
            ...
            const response = await axios.get(
              `https://kabi.pk.go1.kworld.kpmg.com/api/interview/stages/${interview.id}/${interview.stages[0].stage_id}/result`
            );
            if (isMounted) {
        ...
        if (selectedApplicant?.id) {
          try {
            const response = await axios.get(
              `https://kabi.pk.go1.kworld.kpmg.com/api/applicant/${selectedApplicant.id}/offer-status`
            );
            if (isMounted) {
