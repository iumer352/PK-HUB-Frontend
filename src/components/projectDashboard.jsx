...
const ProjectDashboard = () => {
  ...
  const handleUpdateProject = async (projectId, updates) => {
    try {
      setLoading(true);
      const response = await fetch(`http://10.183.199.14:5000/api/projects/${projectId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleAssignEmployee = async (projectId, employeeId) => {
    ...
    try {
      const response = await fetch(`http://10.183.199.14:5000/api/projects/${projectId}/assign`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      const projectResponse = await fetch(`http://10.183.199.14:5000/api/projects/${projectId}`);
